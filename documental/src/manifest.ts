...
const ManifiestoSchema = z.object({
  empresa: z.object({
    ...
    ccRepresentante: z.string().optional(),
    ccExpedidaEn: z.string().optional(),
    responsableIVA: z.boolean().optional(),
    contadora: z.string().optional(),
    tpContadora: z.string().optional(),
    direccion: z.string().optional(),
    telefonoComercial: z.string().optional(),
    emailGerencia: z.string().optional(),
    regimen: z.string().optional(),
    actividadPrincipal: z.object({ fechaInicio: z.string().optional() }).partial().optional(),
  }),
